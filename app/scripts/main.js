...
function myOnload() {
  ...
  for (var e, o = function () {}, t = ['assert', 'clear', 'count', 'debug', 'dir', 'dirxml', 'error', 'exception', 'group', 'groupCollapsed', 'groupEnd', 'info', 'log', 'markTimeline', 'profile', 'profileEnd', 'table', 'time', 'timeEnd', 'timeline', 'timelineEnd', 'timeStamp', 'trace', 'warn'], a = t.length, i = window.console = window.console || {}; a--;) e = t[a], i[e] || (i[e] = o);
}(), window.onload = myOnload, $(function () {
  function e() {
    var e = !1;
    return function (o) {
  ...
  var a = e() ? 'touchstart' : 'click',
    i = $('.slide'),
    n = $('.content');
  $('#navToggle').on(a, function (e) {
    e.stopPropagation(), e.preventDefault(), n.hasClass('open') ? t() : o();
  }), n.click(function () {
    n.hasClass('open') && t();
  });
}), $(function () {
  $('a[href*=#]:not([href=#])').click(function (e) {
    if (e.preventDefault(), location.pathname.replace(/^\//, '') === this.pathname.replace(/^\//, '') && location.hostname === this.hostname) {
      var o = $(this.hash);
      if (o = o.length ? o : $('[name=" + this.hash.slice( 1 ) + "]'), o.length && ($('html,body').animate({
          scrollTop: o.offset().top
        }, 1e3), matchMedia('only screen and (max-width: 1100px)').matches)) return $('html,body').animate({
...
(function (root, factory) {
  ...
  Support.mobileTouch = Support.touch &&
    (Browser.MobileSafari || Browser.Android || Browser.IEMobile || Browser.ChromeMobile || !/^(Win|Mac|Linux)/.test(navigator.platform));
  ...
  if (
    // IE6
    (Browser.IE && Browser.IE < 7) || ($.type(Browser.Android) == 'number' && Browser.Android < 3) || (Browser.MobileSafari && ($.type(Browser.WebKit) == 'number' && Browser.WebKit < 533.18))
  ) {
